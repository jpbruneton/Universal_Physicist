...
Usage:
    py -3 main3.py                         # run with default question
    py -3 main3.py --rounds 5
    py -3 main3.py --no-latex
    py -3 main3.py --resume SESSION_ID
    py -3 main3.py --skip-download         # skip paper download step
...
# Round 1: GR + Math — lay out the covariant frameworks, field equations, actions
# Round 2: Meaning + Devil — multi-scale constraints, what passes/fails
# Round 3: Wild + Verifier — bold proposals + equation checks
# Round 4: GR + Devil + Lit — sharpen, observational predictions, literature grounding
...
MODIFIED_GRAVITY_PAPERS = [
    # --- MOND foundations ---
    "astro-ph/0112528",   # Milgrom 2001 — MOND review (Acta Astronomica)
    "astro-ph/0207231",   # Milgrom 2002 — MOND: the predictions
    "0911.5464",          # Milgrom 2009 — Bimetric MOND gravity
    "1212.2152",          # Milgrom 2012 — MOND laws of galactic dynamics
    "2303.04368",         # Milgrom 2023 — MOND vs dark matter in galaxy groups

    # --- TeVeS (Bekenstein) ---
    "astro-ph/0403694",   # Bekenstein 2004 — Relativistic MOND (TeVeS)
    "astro-ph/0512011",   # Bekenstein & Sagi 2008 — New TeVeS and gravitational lensing
    "astro-ph/0601099",   # Sanders 2006 — TeVeS and galaxy clusters
    "astro-ph/0502222",   # Sanders 2005 — TeVeS and CMB
    "astro-ph/0511591",   # Skordis et al. 2006 — CMB power spectrum in TeVeS
    "0801.1985",          # Skordis 2008 — TeVeS cosmology

    # --- RMOND / AMOND (Skordis & Zlosnik) ---
    "2109.13287",         # Skordis & Zlosnik 2021 — Relativistic MOND (RMOND)
    "1907.09003",         # Skordis & Zlosnik 2019 — RMOND precursor
    "2303.05023",         # Skordis 2023 — AMOND extension

    # --- Bruneton & Esposito-Farese ---
    "gr-qc/0602051",      # Bruneton & Esposito-Farese 2007 — field-theoretical selfgravitation
    "0807.1567",          # Bruneton et al. 2009 — viable covariant MOND models
    "1007.2483",          # Esposito-Farese 2011 — comparing MOND and dark matter

    # --- Famaey & McGaugh review ---
    "1112.3960",          # Famaey & McGaugh 2012 — Living Reviews: MOND

    # --- Radial Acceleration Relation ---
    "1609.05917",         # McGaugh, Lelli, Schombert 2016 — RAR discovery
    "1703.10309",         # Lelli et al. 2017 — RAR with SPARC sample
    "2109.04781",         # Chae et al. 2021 — RAR in ellipticals

    # --- Baryonic Tully-Fisher ---
    "astro-ph/0506582",   # McGaugh 2005 — baryonic Tully-Fisher

    # --- Galaxy clusters / Bullet Cluster problem ---
    "astro-ph/0608407",   # Clowe et al. 2006 — Bullet Cluster direct evidence CDM
    "astro-ph/0606216",   # Angus, Famaey, Buote 2008 — clusters in MOND
    "0803.3089",          # Angus et al. 2008 — CMB and MOND with sterile neutrinos

    # --- Emergent gravity (Verlinde) ---
    "1611.02269",         # Verlinde 2016 — emergent gravity and dark matter
    "1809.00840",         # Hossenfelder & Mistele 2018 — covariant emergent gravity

    # --- Dipolar dark matter (Blanchet) ---
    "astro-ph/0607246",   # Blanchet 2007 — dipolar dark matter and MOND
    "1105.5815",          # Blanchet & Heully 2012 — gravitational polarization

    # --- MOND and large-scale structure / Hubble ---
    "1909.09218",         # Kroupa et al. 2019 — MOND cosmological simulations
    "2112.15218",         # Banik & Zhao 2021 — MOND review (confrontation with data)

    # --- PPN / Solar system constraints ---
    "gr-qc/0510072",      # Will 2006 — confrontation of GR with experiment (PPN)
]
