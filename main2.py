...
Usage:
    py -3 main2.py                         # run with default question
    py -3 main2.py --rounds 5              # more rounds
    py -3 main2.py --no-latex              # skip LaTeX output
    py -3 main2.py --resume SESSION_ID     # resume a previous session
    py -3 main2.py --input "Try finite-difference Dirac on a null lattice"
    py -3 main2.py --list-sessions
"""
